...
if(isset($_POST['userlogin'])){
    ...
    $query = "SELECT * FROM `userInfo` WHERE `userEmail` = '$userEmail' ";
    ...
    echo "<script> alert('Please Insert Correct Email) </script>";
}
    ...
    <div class="container">
      ...
      <span><i id="passwordToggler"class="bi bi-eye-slash"></i></span>
              ...
              <div class="col-12 d-grid"> 
                <button type="submit" name="userlogin" class="btn btn-primary">Sign In</button>
              </div>
              <!-- link -->
