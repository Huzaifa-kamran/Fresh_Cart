...
if($userFname == "" || $userLname == "" || $userEmail == "" ||$userPassword == "" || $fileName == ""){

  echo "<script> alert('please fill all the form fields') </script>";
}else{
$query = "INSERT INTO `userinfo` ( `user_fname`, `user_lname`, `userEmail`,
 `userPassword`, `picture`) VALUES ( '$userFname', '$userLname', '$userEmail', '$bcryptPass', '$fileName')";
  ...
  if ($res){
    ...
    if ($type == 'image/jpg' || $type == 'image/png' || $type == 'image/jpeg') {
      ...
      if (move_uploaded_file($tmpName, '../uploads/' . $fileName)) {
        ...
        echo "<script> window.location.href = 'http://localhost/freshCart/' </script>";
      }
  } else {
        ...
        <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
          ...
          <form method="POST" action="signup.php" enctype="multipart/form-data">
            <div class="row g-3">
              <!-- col -->
              <div class="col">
                <!-- input --><input type="text" name="fname"class="form-control" placeholder="First name" aria-label="First name"
                  required>
              </div>
              <div class="col">
                <!-- input --><input type="text" name="lname" class="form-control" placeholder="Last name" aria-label="Last name"
                  required>
              </div>
              <div class="col-12">
...
<!-- input --><input type="file" name="image" class="form-control" id="inputEmail4" placeholder="Email" required>
</div>
