...
`categories`.`categoryID` WHERE `proID` = $id";
        ...
        <div class="col-12">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
              ...
              <li class="breadcrumb-item"><a href="#"><?php echo $data['categoryName'];?></a></li>

              <li class="breadcrumb-item active" aria-current="page"><?php echo $data['proName'];?></li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="product" id="product">
            <div class="zoom" onmousemove="zoom(event)"
              style="background-image: url(../assets/images/products/<?php echo $data['proImg'];?>);
              background-repeat: no-repeat;background-position: center;">
              <!-- img -->
              <!-- img --><img src="../assets/images/products/<?php echo $data['proImg'];?>" alt="">
            </div>
        ...
        <div class="col-md-6">
          <div class="ps-lg-10 mt-6 mt-md-0">
            <!-- content -->
            <a href="#!" class="mb-4 d-block"><?php echo $data['categoryName'];?></a>
            <!-- heading -->
            <h1 class="mb-1"><?php echo $data['proName'];?> </h1>
            <div class="mb-4">
              <!-- rating -->
