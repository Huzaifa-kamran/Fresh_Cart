...
<div class="modal fade" id="locationModal" tabindex="-1" aria-labelledby="locationModalLabel" aria-hidden="true">
  ...
  <main>
    ...
    <section class="my-lg-14 my-8">
      <div class="container">
        ...
        $products = "SELECT * FROM `products` INNER JOIN `categories` ON `products`.`catID` = 
            ...
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-center position-relative ">
                  ...
                  <a href="pages/shop-single.php?proid=<?php echo $row['proID']?>"> <img src="assets/images/products/<?php echo $row['proImg']?>" alt="Grocery Ecommerce Template"
                      class="mb-3 img-fluid"></a>

                  <div class="card-product-action">
                    <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal<?php echo $row['proID']?>"><i
                ...
                <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small><?php echo $row['categoryName']?></small></a></div>
                <h2 class="fs-6"><a href="pages/shop-single.php?proid=<?php echo $row['proID']?>" class="text-inherit text-decoration-none"><?php echo $row['proName']?></a></h2>
                <div>
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                  <div><span class="text-dark"><?php echo $row['proPrice']?></span> <span
                      class="text-decoration-line-through text-muted">$24</span>
                  </div>
                  <div><a href="pages/shop-cart.php?proID=<?php echo $row['proPrice']?>" class="btn btn-primary btn-sm">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
  ...
  <!-- Modal -->
<div class="modal fade" id="quickViewModal<?php echo $row['proID']?>" tabindex="-1" aria-hidden="true">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="product productModal" id="productModal">
              <div
                ...
                style="
                  background-image: url(assets/images/products/<?php echo $row['proImg']?>);
                  background-repeat: no-repeat;
                "
              >
                <img
                  src="assets/images/products/<?php echo $row['proImg']?>"
                  alt=""
                />
              </div>
          ...
          <div class="col-lg-6">
            <div class="ps-lg-8 mt-6 mt-lg-0">
              <a href="#!" class="mb-4 d-block"><?php echo $row['categoryName']?></a>
              <h2 class="mb-1 h1"><?php echo $row['proName']?></h2>
              <div class="mb-4">
              ...
              <div class="fs-4">
                <span class="fw-bold text-dark">$<?php echo $row['proPrice']?></span>
              ...
              <div>
                <table class="table table-borderless">
                  <tbody>
                    ...
                    <tr>
                      <td>Availability:</td>
                      <td><?php if($row['inStock']==1){ echo "In Stock";}
